...
class botinfo(commands.Cog):
    ...
    async def help(self, interaction : discord.Interaction):
        return await interaction.response.send_message("You can find all commands at [The documentation](<https://yokaigroup.gg/projects/kiriko-bot/kiriko-documentation/>)")
